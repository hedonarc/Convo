...
def _load_translations():
    ...
    # Logic: backend/utils/translations.py -> backend/translations/en.json
    translation_file = (
    ...
    try:
        ...
        logger.error(f"Translation file not found at: {translation_file}")
        return {}
    except json.JSONDecodeError:
        logger.error(f"Failed to decode translation file at: {translation_file}")
        return {}
